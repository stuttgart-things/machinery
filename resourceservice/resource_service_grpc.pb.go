...
func (c *resourceServiceClient) GetResourceDetail(ctx context.Context, in *ResourceDetailRequest, opts ...grpc.CallOption) (*ResourceStatus, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
func _ResourceService_GetResourceDetail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ResourceServiceServer).GetResourceDetail(ctx, req.(*ResourceDetailRequest))
	}
	return interceptor(ctx, in, info, handler)
}
